...
async function fetchNoticia(id: number | null): Promise<Noticia | null> {
...
// Mesma paleta do card de dica — mantém a linguagem visual do app.
...
export async function GET(req: NextRequest) {
  try {
    ...
    if (!noticia) throw new Error('Nenhuma noticia_clima encontrada')
    ...
    return new Response('OG Noticia error: ' + msg, { status: 500 })
  }
}
